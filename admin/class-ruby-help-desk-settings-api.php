...
class RHD_Settings_API {
    ...
    function callback_button( $args ) {
        ...
        $html        = sprintf( '<input class="button button-primary" type="%1$s" id="%3$s" name="%3$s" value="%4$s"/><div id="%3$s_spinner" class="rhd_spinner"></div><div id="%3$s_spinner_result" class="rhd_spinner_result"></div>', $type, $args['section'], $args['id'], $placeholder );
        $html       .= $this->get_field_description( $args );
     ...
     * @return string
     */
    function get_option( $section, $option = '', $default = '' ) {
